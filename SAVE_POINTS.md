...
| :--- | :--- | :--- |
| **Current** | `9346412` | **Imports & Editing Overhaul**<br>Fixed PDF (Worker) & DXF imports, added Alt+Click/Drag & Box Selection for imports, Single DXF mode, Delete key, and Wall Endpoint Handles (Node Editing). |
